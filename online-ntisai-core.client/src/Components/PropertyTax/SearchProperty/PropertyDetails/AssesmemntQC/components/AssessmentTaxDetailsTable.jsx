...
const AssessmentTaxDetailsTable = () => {
    ...
    const totalTaxRow = tableData.find(
        (row) => row.taxes === "Total Tax",
    );
    const individualTaxRows = tableData.filter(
        (row) => row.taxes !== "Total Tax",
    );

    // Sort only the individual tax rows based on sort configuration
    const sortedIndividualRows = [...individualTaxRows].sort(
        (a, b) => {
                    ...
                    <table className="w-full text-xs">
                        <thead>
                            <tr className="bg-[#F5F9FF] border-b border-gray-300">
                                <th
                                    className="px-1.5 py-1.5 text-left border-r border-gray-300 font-bold text-gray-900 min-w-[120px] cursor-pointer hover:bg-blue-100 select-none"
                                ...
                                <th
                                    className="px-1.5 py-1.5 text-left border-r border-gray-300 font-bold text-gray-900 min-w-[60px] cursor-pointer hover:bg-blue-100 select-none"
                                ...
                                <th
                                    className="px-1.5 py-1.5 text-left border-r border-gray-300 font-bold text-gray-900 min-w-[70px] cursor-pointer hover:bg-blue-100 select-none"
                                ...
                                <th
                                    className="px-1.5 py-1.5 text-left border-r border-gray-300 font-bold text-gray-900 min-w-[50px] cursor-pointer hover:bg-blue-100 select-none"
                                ...
                                <th
                                    className="px-1.5 py-1.5 text-left border-r border-gray-300 font-bold text-gray-900 min-w-[80px] cursor-pointer hover:bg-blue-100 select-none"
                                ...
                                <th
                                    className="px-1.5 py-1.5 text-left font-bold text-gray-900 min-w-[50px] cursor-pointer hover:bg-blue-100 select-none"
                        ...
                        <tbody>
                            {displayedData.map((row, index) => (
                                <tr
                                    key={index}
                                    className={`border-b border-gray-200 hover:bg-yello-50 ${row.taxes === "Total Tax" ? "bg-yellow-50 font-semibold" : ""}`}
                                >
                                    <td className="px-1.5 py-1.5 border-r border-gray-200 text-gray-900 font-bold">
                                        {row.taxes}
                                    </td>
                                    <td className="px-1.5 py-1.5 border-r border-gray-200 text-gray-800">
                                        {row.rv}
                                    </td>
                                    <td className="px-1.5 py-1.5 border-r border-gray-200 text-gray-800">
                                        {row.propTax}
                                    ...
                                    <td className="px-1.5 py-1.5 text-gray-800">
                                        {row.tax2}
                                    </td>
                                </tr>
                            ))}
