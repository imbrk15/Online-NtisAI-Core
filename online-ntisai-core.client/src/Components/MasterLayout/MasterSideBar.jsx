...
function MasterSidebar({ basePath = "", items = [] }) {
                ...
                <nav className="py-0">
                    {items.map(({ to, label, icon: Icon, end }) => (
                        <NavLink
                            ...
                            className={({ isActive }) =>
                                [
                                    "group relative h-10 my-1 flex items-center transition rounded-full",
                                    collapsed
                                        ? "justify-center px-0"
                                    ...
                                    {Icon && (
                                        <Icon
                                            className={[
                                                ...
                                                isActive ? "text-[#0f2540]" : "text-[#DCE7F4]",
                                            ].join(" ")}
                                        />
                                    )}
                                    <span
                                        className={[
                                            ...
                                            isActive ? "font-medium text-[#0f2540]" : "text-[#DCE7F4]",
                                        ].join(" ")}
                                    >
                                        {label}
                                    </span>
