...
export function Calendar({ className, classNames: userClassNames, ...props }: CalendarProps) {
    return (
        <DayPicker
            {...props}
            showOutsideDays
            ...
            classNames={{
                ...
                nav_button: cn(
                    ...
                    "size-7 bg-transparent p-0 opacity-50 hover:opacity-100 flex items-center justify-center"
                ),
            ...
            components={{
                Button: ({ dir, ...props }) => (
                    <button {...props} type="button" className={cn(buttonVariants({ variant: "outline" }), "p-1")}>
