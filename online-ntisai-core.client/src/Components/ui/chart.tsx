                ...
                {payload.map((item, index) => {
                    ...
                    return (
                        <div
                            ...
                            className={cn("[&>svg]:text-muted-foreground flex w-full flex-wrap items-stretch gap-2", indicator === "dot" && "items-center")}
                        >
...
interface ChartLegendContentProps extends Omit<RechartsPrimitive.LegendProps, "content"> {
    className?: string;
    hideIcon?: boolean;
    nameKey?: string;
    payload?: RechartsPayloadItem[];
